...
Then, for each strategy, the .loci file generated by ipyrad, that presents the reads associated with each locus, was saved with the name of the individual from which the sample originated. We used the R script, [blast_Holmes2018.R](https://github.com/daniel-acga/RADSeqMicrobiome/blob/master/bin/blast_Holmes2018.R) written by [Holmes and Rabosky, 2018](https://peerj.com/articles/4662/) to take the first sequence of each locus and group them into a fasta file that was later processed using the [blastn tool](https://blast.ncbi.nlm.nih.gov/Blast.cgi?PAGE_TYPE=BlastDocs&DOC_TYPE=Download
