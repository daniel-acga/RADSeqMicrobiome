##RADSeq Microbiome results analysis script
##Por Daniel E. Acosta
...
#Fix the data into a frequency matrix and plotting
...
p <- table(taxx_x$V1, taxx_x$V3) + ggtitle ("Filtered matches, 90% similirity") 
p
